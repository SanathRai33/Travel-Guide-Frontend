...
export default function About() {
  ...
  return (
    <div className=" bg-red-800 About">
      <motion.div
      ...
      >
        ...
        <h4>
          Welcome to Regal Roamers – where every journey is crafted to
          perfection! We specialize in premium guided tours that blend
          adventure, culture, and luxury. Whether you're a history enthusiast,
          nature lover, or thrill-seeker, we ensure an unforgettable experience
          filled with stunning landscapes, rich heritage, and personalized
          service
        </h4>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <ul>
          ...
          <li>
            Certified tour guides with in-depth knowledge of history, culture,
            and local traditions.
          </li>
          <li>
            Partnerships with renowned travel organizations and premium
            accommodations.
          </li>
          <li>
            Multilingual team offering tours in English, Hindi, Kannada, and
            more.
          </li>
        </ul>
      </motion.div>
      ...
      >
        ...
        <div className="loc-add">
          ...
          <p>
            With a strong presence in India and expanding footprints worldwide,
          </p>
          <p>
            <FaMapMarkerAlt size={20} className="icn" />
            Headquarters: Mangalore, India
          </p>
          <p>
            <FaGlobeAsia size={18} className="icn" />
            Our Coverage Areas:
          </p>
          <p>
            India: Rajasthan, Kerala, Goa, Himachal Pradesh, Karnataka, and
            more.
          </p>
          <p>
            International: Thailand, Dubai, Maldives, and select European
            destinations.
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <p>
          At Regal Roamers, we believe in creating journeys that aren’t just
          about sightseeing but immersing yourself in new cultures, cuisines,
          and experiences. Our passion for travel drives us to go beyond the
          ordinary, ensuring that every trip is unique, luxurious, and
          unforgettable.
        </p>
        <p>
          "Travel is not just about places; it's about the stories you collect
          along the way." – Regal Roamers Team
        </p>
      </motion.div>
    </div>
  );
